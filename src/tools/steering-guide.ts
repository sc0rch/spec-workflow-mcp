...
When the server runs without a startup path, it resolves the active project from the MCP client roots. Use \`projectPath\` only as an explicit workspace/worktree override on approval and status calls.
